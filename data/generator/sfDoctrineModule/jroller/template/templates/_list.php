<div class="sf_admin_list ui-grid-table ui-widget ui-corner-all ui-helper-reset ui-helper-clearfix">
  ...
  <table>
    ...
    <tbody>
      ...
      [?php if ($<?php echo $this->getSingularName() ?>->contains('archived_at')) $color = $<?php echo $this->getSingularName() ?>->get('archived_at') ? 'td_admin_row_mark_grey' : ''; ?]
      [?php if ($<?php echo $this->getSingularName() ?>->contains('deleted_at')) $deleted = $<?php echo $this->getSingularName() ?>->get('deleted_at') ? 'td_admin_row_mark_deleted' : ''; ?]
        <tr class="sf_admin_row ui-widget-content [?php echo $odd ?] [?php if (isset($color)) echo $color; ?] [?php if (isset($deleted)) echo $deleted; ?]">
          <?php if ($this->configuration->getValue('list.batch_actions')): ?>
